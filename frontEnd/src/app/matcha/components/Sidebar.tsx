...
const Sidebar = () => {
  ...
  return (
    <div className=" flex flex-col h-full justify-between bg-primary">
      <div className=" hidden md:flex flex-col h-full w-72 min-w-64 drop-shadow-xl  sticky">
      ...
      <Button variant="light" color="primary" className=" text-white hover:text-secondary mb-12 px-8 py-6">
